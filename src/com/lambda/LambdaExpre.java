...
public class LambdaExpre {
    ...
    public void phoneNumIsValid(String phonenum) throws UserRegistrationException{
        try {
            if (checkValid.mathPattern(phoneNumPattern, phonenum)){
                ...
                throw new UserRegistrationException("Please Enter a Valid Mobile Num ex:- 91 9052824862");
            }
        }catch (UserRegistrationException e){
            System.out.println(e.getMessage());
        }
    ...
    public static void main(String[] args) throws UserRegistrationException {
        LambdaExpre usr = new LambdaExpre();
        ...
        do {
            ...
            System.out.println("3: Check phoneNum ");
